...
},{"./blocks":73,"./events":84,"./function-bind":93,"./lodash":98,"./renderable":100}],56:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./block-control":55,"./blocks":73,"./event-bus":83,"./events":84,"./function-bind":93,"./lodash":98,"./mediated-events":99,"./renderable":100}],57:[function(require,module,exports){
"use strict";
...
},{"./blocks":73,"./config":80,"./event-bus":83,"./events":84,"./function-bind":93,"./lodash":98,"./mediated-events":99,"./utils":104}],59:[function(require,module,exports){
"use strict";
...
},{"./function-bind":93,"./renderable":100}],60:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./event-bus":83,"./function-bind":93,"./lodash":98,"./renderable":100}],61:[function(require,module,exports){
"use strict";
...
module.exports = {
  ...
  createStore: function(blockData) {
      utils.log("createStore() for block");
    this.blockStorage = {
   ...
   */
  save: function() {
    utils.log("save() called in line 2926");
    utils.log(this);
  ...
  getData: function() {
    utils.log("getData() for block");
    this.save();
    return this.blockStorage;
  },

  getBlockData: function() {
    utils.log("getBlockData() for block");
    this.save();
    return this.blockStorage.data;
  },

  _getData: function() {
      utils.log("_getData() for block");
    return this.blockStorage.data;
  },
...
},{"./event-bus":83,"./lodash":98,"./utils":104}],62:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./lodash":98,"./utils":104}],63:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./block-deletion":57,"./block-positioner":59,"./block-reorder":60,"./block-validations":62,"./block_mixins":68,"./config":80,"./event-bus":83,"./formatters":92,"./helpers/extend":95,"./lodash":98,"./simple-block":101,"./to-html":102,"./to-markdown":103,"./utils":104,"spin.js":54}],64:[function(require,module,exports){
"use strict";
...
},{"../utils":104}],65:[function(require,module,exports){
(function (global){
"use strict";
...
},{"../config":80,"../event-bus":83,"../lodash":98,"../utils":104}],67:[function(require,module,exports){
(function (global){
"use strict";
...
},{"../lodash":98,"./ajaxable":64}],68:[function(require,module,exports){
"use strict";
...
},{"../config":80,"../lodash":98,"../utils":104}],70:[function(require,module,exports){
"use strict";
...
},{"../config":80,"../extensions/file-uploader":86,"../lodash":98,"../utils":104,"./ajaxable":64}],71:[function(require,module,exports){
"use strict";
...
},{"../block":63,"../to-html":102}],72:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./heading":71,"./image":72,"./list":74,"./quote":75,"./text":76,"./tweet":77,"./video":78,"./widget":79}],74:[function(require,module,exports){
"use strict";
...
module.exports = Block.extend({
  ...
  isEmpty: function() {
      utils.log("isEmpty() again");
    return _.isEmpty(this.getBlockData().text);
  }

});

},{"../block":63,"../lodash":98,"../to-html":102}],75:[function(require,module,exports){
"use strict";
...
},{"../block":63,"../lodash":98,"../to-html":102}],76:[function(require,module,exports){
"use strict";
...
},{"../block":63,"../to-html":102}],77:[function(require,module,exports){
(function (global){
"use strict";
...
},{"../block":63,"../lodash":98,"../utils":104}],78:[function(require,module,exports){
"use strict";
...
},{"../block":63,"../lodash":98,"../utils":104}],79:[function(require,module,exports){
"use strict";
...
module.exports = Block.extend({
  ...
  onNoWidgetCopied: function(){
      alert('Couldn\'t copy widget!');
  }

});

},{"../block":63,"../lodash":98}],80:[function(require,module,exports){
"use strict";
...
//    this.scrollTo(block.$el);
  ...
  validateAndSaveBlock: function(block, shouldValidate) {
      utils.log("validateAndSaveBlock() for block");
...
},{"./block-controls":56,"./block-manager":58,"./config":80,"./error-handler":82,"./event-bus":83,"./events":84,"./extensions/editor-store":85,"./floating-block-controls":88,"./form-events":89,"./format-bar":90,"./function-bind":93,"./lodash":98,"./utils":104}],82:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./block":63,"./block-control":55,"./block-controls":56,"./block-deletion":57,"./block-manager":58,"./block-positioner":59,"./block-reorder":60,"./block-store":61,"./block-validations":62,"./block_mixins":68,"./blocks":73,"./config":80,"./editor":81,"./event-bus":83,"./events":84,"./extensions/editor-store":85,"./extensions/file-uploader":86,"./extensions/submittable":87,"./floating-block-controls":88,"./form-events":89,"./format-bar":90,"./formatter":91,"./formatters":92,"./helpers/event":94,"./locales":97,"./lodash":98,"./simple-block":101,"./to-html":102,"./to-markdown":103,"./utils":104,"./vendor/array-includes":105,"array.prototype.find":2,"object.assign":51}],97:[function(require,module,exports){
"use strict";
...
},{"lodash.isempty":4,"lodash.isfunction":28,"lodash.isobject":29,"lodash.isstring":31,"lodash.isundefined":32,"lodash.result":33,"lodash.template":34,"lodash.uniqueid":50}],99:[function(require,module,exports){
"use strict";
...
Object.assign(SimpleBlock.prototype, require('./function-bind'), require('./events'), require('./renderable'), require('./block-store'), {
  ...
  _blockPrepare : function() {
    utils.log("_blockPrepare() for block");
    this._initUI();
    this._initMessages();
...
},{"./block-reorder":60,"./block-store":61,"./events":84,"./function-bind":93,"./helpers/extend":95,"./lodash":98,"./renderable":100,"./utils":104}],102:[function(require,module,exports){
"use strict";
...
},{"./blocks":73,"./formatters":92,"./lodash":98,"./utils":104}],103:[function(require,module,exports){
"use strict";
...
},{"./blocks":73,"./formatters":92,"./lodash":98,"./utils":104}],104:[function(require,module,exports){
"use strict";
