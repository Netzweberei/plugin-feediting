...
//    },
    youtube: {
      ...
      html: "<iframe src=\"https://www.youtube.com/embed/<%= remote_id %>\" width=\"480\" height=\"320\" frameborder=\"0\" allowfullscreen></iframe>"
    }
  },
  ...
  paste_options: {
    html: ['<input type="text" placeholder="Paste youtube-URL here"',
        ' class="st-block__paste-input st-paste-block">'].join('')
  },
